...
class Column(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        # Assign a random gap size between 90 and 200 pixels
        if RANDOM_PIPE:
            self.gap = random.randint(90, 200)
        else:
            self.gap = game.configs.PIPE_GAP_SIZE
    ...
    def update(self, *args, **kwargs):
        self.rect.x -= 4  # Adjust speed if needed
